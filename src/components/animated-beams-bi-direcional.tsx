...
>(({ className, children, tooltip }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] transition-all duration-300 hover:scale-110 ",
        className
      )}
    >
      <Tooltip>
...
export function AnimatedBeamsBiDirecional() {
...
const Icons = {
  ...
  speedchars: () => (
    ...
    >
      ...
      >
        <path
          d="M2264 3125 c-208 -31 -408 -92 -576 -176 -106 -53 -131 -72 -45 -35
...
-35 70 -61 103 -143 186 -138 138 -276 217 -487 278 -189 54 -473 71 -684 41z"
        />
        <path
          d="M1695 2595 c-324 -37 -637 -111 -905 -215 l-55 -21 145 6 c80 4 159
